...
public class Data {
  ...
  static public Video newVideo(String title, int year, String director) {
    ...
    Triple<String, Integer, String> vidtriple = Triple.of(_title, _year, _director);
    VideoObj vid =  (VideoObj) videoCache.get(vidtriple);
    if(vid == null) {
    	vid = new VideoObj(_title, _year, _director);
    	videoCache.put(vidtriple, vid);
    }
    return vid;
  }
